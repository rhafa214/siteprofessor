    ...
    <div className="p-4 grid grid-cols-2 gap-3">
      {[6, 7, 8, 9].map((ano) => (
        <button
          ...
          className="bg-white border text-center border-slate-200 rounded-xl p-4 shadow-sm hover:border-[#8257E5] hover:shadow-md transition-all group flex flex-col items-center justify-center gap-2"
        >
          <div className="w-12 h-12 bg-indigo-50 rounded-full flex items-center justify-center text-[#8257E5] font-bold text-lg group-hover:scale-110 transition-transform">
            {ano}º
          </div>
          <span className="font-semibold text-slate-700">{ano}º Ano</span>
        </button>
      ))}
    </div>
  );
